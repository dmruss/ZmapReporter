...
class Plotter:
    ...
    def __init__(self, output_directory, port, sample):
        ...
        self.fig = plt.figure(figsize=(50,30))
        self.grid_size = (4,6)
    ...
    def plot_map(self, banner_dfs):
        ...
        ax0 = plt.subplot2grid(self.grid_size, (0,0), colspan=4)
    ...
    def plot_success(self, banner_dfs):
        ...
        for grab_type in banner_dfs.keys():
            ...
            ax = plt.subplot2grid(self.grid_size, (1,col))
    ...
    def plot_http_server(self, banner_dfs):
        ...
        ax = plt.subplot2grid(self.grid_size, (2,0), colspan=6)
    ...
    def plot_ssh_software(self, banner_dfs):
        ...
        ax.hist(ssh_df['software'].dropna())
